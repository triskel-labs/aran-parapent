<section id="about-section" class="bg-neutral-100 w-full h-full flex flex-col justify-center items-center">
    <div class="max-w-7xl h-full w-full flex flex-col justify-center items-center py-16 md:py-28 px-8 gap-8 md:gap-12 md:flex-row-reverse">
        <div class="h-full w-full flex flex-col gap-4 justify-center md:justify-between items-center md:items-start max-w-2xl">
        ...
        <div class="image-container flex flex-col justify-center items-center gap-1">
                <img src="/pau.webp" alt="Pau" width="540" height="537" loading="lazy" decoding="async" class="object-cover rounded-lg">
